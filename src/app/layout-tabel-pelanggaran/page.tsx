...
/**
 * Layout Tabel Pelanggaran Page
 * 
 * Menampilkan PDF layout tabel pelanggaran secara langsung (embedded) 
...
const PDF_PATH = `${basePath}/layout-tabel-pelanggaran.pdf`;
...
export default function LayoutTabelPelanggaranPage() {
  return (
    <div>
      {/* Header */}
      <div style={{ marginBottom: 20, display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: 16 }}>
        <div>
          <h1 style={{ fontSize: 22, fontWeight: 800, color: 'var(--primary)', marginBottom: 4 }}>
            Layout Tabel Pelanggaran
          </h1>
          <p style={{ fontSize: 14, color: 'var(--text-muted)' }}>
            Dokumen layout tabel pelanggaran peserta kaderisasi PROXIMITI.
          </p>
        </div>
        ...
        <a
          href={PDF_PATH}
          download="Layout-Tabel-Pelanggaran-PROXIMITI.pdf"
      ...
      <div className="card" style={{ padding: 0, overflow: 'hidden' }}>
        ...
        <iframe
          ...
          title="Layout Tabel Pelanggaran PDF"
        />
      </div>
